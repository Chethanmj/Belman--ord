...
glVertex2i(305,425);
glVertex2i(180,425);glVertex2i(180,395);
glVertex2i(305,395);
glEnd();
glFlush();
glBegin(GL_POLYGON);
...
glColor3f(1.0,1.0,1.0);
drawstring(365.0,235.0,1.0,"2");//5&6glFlush();
}
void shape()
{
//int i,j,temp=0.3;
...
//lines b/w 1&4glVertex2f(115.0,407.5);
...
glColor3f(1,0,0);
glBegin(GL_QUADS);
glVertex2f(316+i,410.0-i);glVertex2f(323.546056+i,403.438213-i);glVertex2f(326.826950+i,407.211241-
i);glVertex2f(319.280894+i,413.773028-i);
glEnd();
glFlush();
delaypacket();
glColor3f(0,0,0);
...
glColor3f(1.0,1.0,1.0);drawstring(160.5,98.5,1.0,"1 -> 3 -> 6");
glColor3f(1.0,1.0,1.0);
...
glColor3f(1.0,1.0,1.0);drawstring(160.5,110.5,1.0,"Shortest path from Node 2 to destination node 6");
glColor3f(1.0,1.0,1.0);
...
glColor3f(0,0,0);
glBegin(GL_QUADS);
glVertex2f(216.546056+i,328.03+i);glVertex2f(218.5+i,323.0+i);glVertex2f(227.894+i,335.773028+i);glVertex2f(225.26950+i,340.211241+i);
glEnd();
glFlush();
}
for(i=0;i<90;i=i+temp)//movement of data packet 3 to 6
...
{ glColor3f(1,0,0);
glBegin(GL_QUADS);
glVertex2f(321.546056+i,216.438213
+i);glVertex2f(316.546056+i,220.0+i);glVertex2f(324.280894+i,226.773028+i);glVertex2f(329.826950+i,224.211241+i);
glEnd();
glFlush();
delaypacket();
glColor3f(0,0,0);
...
delay();
glColor3f(0.0,0.0,0.0);
drawstring(160.5,110.5,1.0,"Shortest path from Node 5 to destination node 6");glColor3f(0.0,0.0,0.0);
drawstring(160.5,98.5,1.0,"5 -> 6");
glColor3f(0.0,0.0,0.0);
drawstring(160.5,86.5,1.0,"Cost C56= 2 ");
glFlush();//////9
...
glColor3f(0.0,0.0,0.0);
drawstring(160.5,98.5,1.0,"2 -> 4 -> 3 -> 6");
glColor3f(0.0,0.0,0.0);drawstring(160.5,86.5,1.0,"Cost C26= 4 (1+2+1) ");
glFlush();//13
}
void node3()
{
...
glColor3f(0.0,0.0,0.0);
drawstring(160.5,98.5,1.0,"5 -> 6");
glColor3f(0.0,0.0,0.0);drawstring(160.5,86.5,1.0,"Cost C56= 2 ");
glFlush();//18
}
